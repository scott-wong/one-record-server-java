    ...
    implements Serializable
{
    ...
    protected Set<OffsetDateTime> arrivalDate;
    /**
     * Departure date and time of the leg
     * 
     */
    @OWLDataProperty(iri = Vocabulary.s_p_departureDate)
    protected Set<OffsetDateTime> departureDate;
    /**
    ...
    public void setArrivalDate(Set<OffsetDateTime> arrivalDate) {
        this.arrivalDate = arrivalDate;
    }

    public Set<OffsetDateTime> getArrivalDate() {
        return arrivalDate;
    }

    public void setDepartureDate(Set<OffsetDateTime> departureDate) {
        this.departureDate = departureDate;
    }

    public Set<OffsetDateTime> getDepartureDate() {
